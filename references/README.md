...
- **Снимок структуры контента и связи с разводящей:** `OBSHEE-CONTENT-SNAPSHOT.md` (пара к снимку UI в репозитории движка: **`docs-app/docs/OBSHEE-LANDING-SNAPSHOT.md`**).
